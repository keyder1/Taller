...
// Clase NodoChar para árboles con caracteres
class NodoChar {
    char dato;
    NodoChar izquierdo;
    NodoChar derecho;
...
// Clase Árbol Binario de Búsqueda con enteros
class ArbolBinarioBusqueda {
    ...
    private Nodo insertarRecursivo(Nodo nodo, int dato) {
        ...
        // Si dato == nodo.dato, no se inserta (evita duplicados)
...
// Clase Árbol Binario de Búsqueda con caracteres
